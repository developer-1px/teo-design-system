import { Role, Prominence } from '../types';
 ...
 */
export function getSeparationTier(role: Role, prominence: Prominence = 'Standard', isInput: boolean = false): SeparationTier {
    ...
    const isDataStructure = role === 'List' || role === 'ListItem' || role === 'Table' || role === 'TableRow' || role === 'Grid' || role === 'GridItem' || role === 'TreeItem';
