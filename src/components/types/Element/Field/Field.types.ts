...
export type FieldRole =
  ...
  | 'Spinbutton'
  | 'Otp'
  | 'Textarea' // NOTE: Spec also mentions multiline Textbox
  | 'NumberInput' // legacy
  | 'TextInput' // legacy
  | 'Input' // legacy
  | 'text' // legacy type alias
  | 'number' // legacy type alias
  | 'checkbox' // legacy type alias
  | 'select' // legacy type alias
  | 'password' // legacy type alias
  ...
  | 'Datepicker'
  | 'Timepicker'
  | 'DateInput' // legacy alias for Datepicker
  | 'TimeInput' // legacy alias for Timepicker
  | 'Filepicker'
  | 'Signature'
...
export type FieldSpec =
  ...
  | {
    ...
    } // Merged Time/Date? Spec says Timepicker is separate.
...
export interface FieldProps extends AsProp {
  ...
  // ===================================================================
  // ⚠️ Compatibility Props (Mapped to IDDL 2.0 specs)
  // ===================================================================
  /** @deprecated Use role="Textbox" etc. */
  type?: string;
  /** @deprecated Move to spec={{ options: [...] }} */
  options?: Option[];
  /** @deprecated Move to spec={{ min: ..., max: ... }} */
  constraints?: Record<string, any>;
  /** @deprecated Move to spec={{ clearable: true }} */
  clearable?: boolean;
  /** @deprecated Use type or role */
  dataType?: any;
}
