 ...
 * Accordion 사용 예시
 *
 * Group role="Accordion"의 다양한 사용 사례를 보여줍니다.
 */

import { useState } from 'react';
import { Group, AccordionItem, AccordionTrigger, AccordionContent } from '../Group';
...
export function BasicAccordion() {
  return (
    <Group role="Accordion" mode="single" defaultValue="item-1" density="Standard">
...
export function MultipleAccordion() {
  return (
    <Group role="Accordion" mode="multiple" defaultValue={['faq-1', 'faq-2']} density="Comfortable">
...
export function ControlledAccordion() {
  ...
  return (
    <div>
      ...
      <Group role="Accordion" mode="single" value={value} onValueChange={handleValueChange} density="Standard">
...
export function AccordionWithCustomIcons() {
  return (
    <Group role="Accordion" mode="single" density="Compact">
      <AccordionItem value="item-1">
...
export function AccordionWithNestedContent() {
  return (
    <Group role="Accordion" mode="single" density="Comfortable">
      ...
      <AccordionItem value="installation">
        ...
        <AccordionContent>
          <div className="space-y-2">
            ...
            <pre className="bg-surface-sunken p-3 rounded text-sm overflow-x-auto">
              <code>{`import { Group, AccordionItem, AccordionTrigger, AccordionContent } from '@/components/types/Group/Group';`}</code>
            </pre>
          </div>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="usage">
        ...
        <AccordionContent>
          <div className="space-y-2">
            <p>Basic example:</p>
            <pre className="bg-surface-sunken p-3 rounded text-sm overflow-x-auto">
              <code>{`<Group role="Accordion" mode="single">
  <AccordionItem value="item-1">
...
export function SettingsAccordion() {
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <Group role="Accordion" mode="multiple" defaultValue={['general']} density="Standard">
