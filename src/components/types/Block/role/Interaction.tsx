...
export function DragDropZone({ Element, children, className, ...props }: BlockRendererProps) {
    return (
        <Element className={cn('border-2 border-dashed border-border-default hover:border-primary hover:bg-primary/5 rounded-xl p-8 flex flex-col items-center justify-center transition-colors cursor-pointer', className)} {...props}>
...
export function Resizable({ Element, children, className, ...props }: BlockRendererProps) {
    return (
        <Element className={cn('relative border border-primary w-[200px] h-[100px] flex items-center justify-center bg-surface-raised', className)} {...props}>
...
export function SelectionArea({ Element, children, className, ...props }: BlockRendererProps) {
    return (
        <Element className={cn('relative border border-border-default h-[200px] bg-grid-pattern', className)} {...props}>
            <div className="absolute left-10 top-10 w-20 h-20 bg-surface border border-border-default shadow-sm rounded flex items-center justify-center text-xs">Item A</div>
            <div className="absolute right-20 bottom-20 w-20 h-20 bg-primary/10 border border-primary shadow-sm rounded flex items-center justify-center text-xs text-primary font-bold">Item B</div>
