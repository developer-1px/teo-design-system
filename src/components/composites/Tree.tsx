...
export function Tree({ data, onNodeClick, selectedId, className }: TreeProps) {
    return (
...
function TreeNodeItem({ node, level, selectedId, onNodeClick }: { node: TreeNode, level: number, selectedId?: string, onNodeClick?: (node: TreeNode) => void }) {
    ...
    return (
        <div className={styles.nodeWrapper}>
            <div
                className={clsx(styles.nodeItem, isSelected && styles.nodeItemActive)}
