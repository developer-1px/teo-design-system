...
export const filterBarPill = style({
    borderRadius: '9999px', // Full radius
    backgroundColor: vars.surface.base.bg, // White background often for pill
    border: `1px solid ${vars.border.subtle}`, // Slight border
    ':hover': {
        backgroundColor: vars.surface.base.bg, // Keep white
        boxShadow: vars.shadow.raised,
    },
    ':focus-within': {
        boxShadow: vars.shadow.overlay, // Stronger shadow
    }
});
