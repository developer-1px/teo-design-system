...
import { Select } from '../../../components/composites/Select';
...
import { Tree } from '../../../components/composites/Tree';
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell, TableCaption } from '../../../components/composites/Table';
import { SearchFilterBar, type FilterTag } from '../../../components/composites/SearchFilterBar';
...
import TableBuilder from '../../admin/components/TableBuilder';
...
export default function ComponentShowcasePage() {
    ...
    console.log("Hello, World!");
                ...
                <section className={styles.sectionWrapper}>
                    <h2 className={styles.sectionTitle}>Advanced Pro Tools</h2>
                    <div className={styles.grid}>
                        <div className={`${styles.card} ${styles.spanTwo}`}>
                            <h2 className={styles.cardTitle}>Table Design Sandbox (MECE PRD Implementation)</h2>
