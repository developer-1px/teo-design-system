...
export const peekOverlay = style({
    position: 'fixed',
    top: 0,
    left: 0,
    width: '100vw',
...
export const scoreboardCard = style({
    width: '100%',
    maxWidth: '1200px',
    height: 'auto',
    maxHeight: '80vh',
...
export const scoreboardHeader = style({
    padding: '24px 32px',
...
export const scoreboardTitle = style({
    fontSize: '18px',
    fontWeight: 800,
    color: '#18181b',
    display: 'flex',
...
export const scoreboardHint = style({
    fontSize: '10px',
    fontWeight: 600,
    color: '#a1a1aa',
    textTransform: 'uppercase',
...
export const scoreboardBody = style({
    flex: 1,
    overflow: 'auto',
    padding: '0',
});
...
// --- RICH TABLE STYLES (Ported from TableDesignerPage) ---

export const richTableWrapper = style({
    width: '100%',
    background: '#fff',
    borderRadius: '12px',
...
export const richGridTable = style({
    display: 'grid',
    width: '100%',
    // gridTemplateColumns set via inline style
});

export const richHeaderCell = style({
    position: 'relative',
    padding: '12px 16px',
    background: '#fafafa',
    borderBottom: `1px solid ${zinc[200]}`,
...
export const richTextStack = style({
    display: 'flex',
    flexDirection: 'column',
    gap: '2px',
    overflow: 'hidden',
...
export const richPrimaryText = style({
    fontWeight: 600,
    color: zinc[900],
    fontSize: '13px',
    whiteSpace: 'nowrap',
...
export const richSecondaryText = style({
    fontSize: '11px',
    color: zinc[500],
    whiteSpace: 'nowrap',
    overflow: 'hidden',
...
export const richAssetThumb = style({
    width: 56,
    height: 40,
    borderRadius: 6,
    overflow: 'hidden',
...
export const richCheckbox = style({
    width: '16px',
    height: '16px',
    borderRadius: '4px',
