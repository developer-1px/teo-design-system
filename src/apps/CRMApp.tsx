...
function SidebarItem({
    ...
    return (
        <Action variant={active ? "surface" : "ghost"} rounded="md" w="100%">
            <Frame row align="center" gap={3} w="100%" p="1.5 2">
                <Icon
                    size={16}
    ...
    return (
        ...
        >
            ...
            <Action variant="ghost" rounded="md">
                <Frame row align="center" gap={3} p="1">
            ...
            <Frame gap={1}>
                ...
                <Frame row align="center" gap={3} p="2">
...
function SectionLabel({ label }: { label: string }) {
    return (
        <Frame p="1 2">
            <Text variant="caption-sm" weight="bold" color="tertiary" style={{ letterSpacing: "0.05em" }}>
                {label.toUpperCase()}
            </Text>
        </Frame>
    );
...
function TableRow({
    ...
    return (
        <Action variant={active ? "surface" : "ghost"} rounded="none" onClick={onClick} w="100%" gap={0}>
            <Frame
                w="100%"
                grid
                columns={TABLE_COLS}
...
function Drawer({
    ...
    onClose,
    deal,
}: { isOpen: boolean; onClose: () => void; deal: Deal | null }) {
...
function PropertyRow({
    ...
    return (
        <Frame row align="center" style={{ height: 32 }} gap={4}>
            <Frame row align="center" gap={2} w={140}>
