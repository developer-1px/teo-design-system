            ...
            <SidebarHeader
                ...
                actions={
                    <div className="flex items-center gap-1">
                        <Action role="IconButton" icon="FileJson" label="Open Settings (JSON)" prominence="Subtle" density="Compact" />
                    </div>
                }
            />
                    ...
                    <Group role="Container" className="flex flex-col gap-3">
                        ...
                        <div className="flex items-start gap-3 p-2 hover:bg-surface-hover rounded-lg">
                            <div className="flex-1 min-w-0 flex flex-col gap-1">
                                ...
                                <Text role="Caption" content="Controls the font family." className="text-text-secondary" />
                                <Input className="h-7 text-xs font-mono mt-1" defaultValue="JetBrains Mono, Menlo, Monaco, 'Courier New', monospace" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-2 hover:bg-surface-hover rounded-lg">
                            <div className="flex-1 min-w-0 flex flex-col gap-1">
                                ...
                                <Text role="Caption" content="Controls the font size in pixels." className="text-text-secondary" />
                                <Input className="h-7 text-xs font-mono mt-1 w-20" type="number" defaultValue="13" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-2 hover:bg-surface-hover rounded-lg">
                            ...
                            <div className="flex-1 min-w-0 flex flex-col gap-1">
                                ...
                                <Text role="Caption" content="Controls whether the minimap is shown." className="text-text-secondary" />
                            </div>
                        </div>
                    ...
                    <Group role="Container" className="flex flex-col gap-3">
                        ...
                        <div className="flex items-start gap-3 p-2 hover:bg-surface-hover rounded-lg">
                            <div className="flex-1 min-w-0 flex flex-col gap-1">
                                ...
                                <Text role="Caption" content="Specifies the color theme used in the workbench." className="text-text-secondary" />
                        ...
                        <div className="flex items-start gap-3 p-2 hover:bg-surface-hover rounded-lg">
                            <div className="flex-1 min-w-0 flex flex-col gap-1">
                                ...
                                <Text role="Caption" content="Specifies the file icon theme used in the workbench." className="text-text-secondary" />
                                <select className="h-7 text-xs mt-1 w-full rounded border border-input bg-background px-2">
