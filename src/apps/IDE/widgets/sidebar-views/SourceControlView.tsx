            ...
            <SidebarHeader
                ...
                actions={
                    <div className="flex items-center gap-1">
                        <Action role="IconButton" icon="LayoutList" label="View as List" prominence="Subtle" density="Compact" />
                        <Action role="IconButton" icon="Check" label="Commit" prominence="Subtle" density="Compact" />
                ...
                <Block role="Container" className="flex flex-col gap-1">
                    <div className="flex items-center justify-between group/header">
                        ...
                        <div className="hidden group-hover/header:flex gap-1">
                            <Action role="IconButton" icon="Plus" label="Stage All" prominence="Subtle" density="Compact" className="h-5 w-5" />
                            <Action role="IconButton" icon="RotateCcw" label="Discard All" prominence="Subtle" density="Compact" className="h-5 w-5" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center px-2 py-1 hover:bg-surface-hover rounded-sm group cursor-pointer">
                        ...
                        <span className="text-xs font-bold text-accent">M</span>
                        <div className="hidden group-hover:flex ml-2 gap-1">
                            <Button variant="ghost" size="icon" className="h-5 w-5"><Plus size={12} /></Button>
                            <Button variant="ghost" size="icon" className="h-5 w-5"><MoveRight size={12} /></Button>
                        </div>
                    </div>

                    <div className="flex items-center px-2 py-1 hover:bg-surface-hover rounded-sm group cursor-pointer">
                        <Text role="Body" content="utils.ts" size="sm" className="flex-1 text-text-tertiary decoration-line-through decoration-text-tertiary" />
