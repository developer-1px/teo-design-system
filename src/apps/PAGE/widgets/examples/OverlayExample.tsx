  ...
  return (
    <Section role="Main" className="flex items-center justify-center p-6 min-h-screen">
      <Block
        role="Card"
        prominence="Strong"
        className="w-full max-w-xl overflow-hidden shadow-soft-xl rounded-[2.5rem]"
      >
        {/* Dialog Header */}
          ...
          <Block role="Toolbar" className="px-10 py-8 bg-transparent">
            <Block role="Stack" className="flex-row items-center gap-6">
              ...
              <Block role="Stack" density="Compact">
                ...
                <Text
                  role="Caption"
                  content="V6.5 INTENT ENGINE • PROJECT SETUP"
                  prominence="Subtle"
          ...
          <Block role="Stack" density="Comfortable" className="px-10 py-10">
            ...
            <Block role="Stack" density="Standard">
              ...
              <Block role="Grid" className="grid-cols-2 gap-4">
                ...
                >
                  ...
                  <Text
                    role="Caption"
                    content="Publicly accessible via IDDL Registry"
                    prominence="Subtle"
                    className="text-[11px] text-white/60 leading-tight mt-1"
                  />
                </Block>
                <Block
                  role="Card"
                  prominence="Subtle"
                  className="p-5 border border-border/50 rounded-2xl cursor-pointer hover:bg-slate-50"
                >
                  <Text
                    role="Label"
                  ...
                  <Text
                    role="Caption"
                    content="Restricted to authorized designers"
                    prominence="Subtle"
            ...
            >
              ...
              <Block role="Stack" density="Compact">
                ...
                <Text
                  role="Caption"
                  content="Current workspace utilization is at 94%. Performance may be throttled."
                  prominence="Standard"
        ...
        <Section role="DialogFooter" variant="Plain">
          <Block
            role="Toolbar"
            className="px-10 py-8 border-t border-border/50 justify-end gap-4 bg-surface-sunken/30"
          >
            ...
            <Action
              ...
              prominence="Strong"
              intent="Brand"
              className="px-8 h-12 rounded-xl font-black uppercase tracking-wider shadow-soft-lg"
            />
          </Block>
        </Section>
      </Block>
