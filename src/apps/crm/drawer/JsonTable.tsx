        ...
        <div style={{
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "auto" }}>
                    ...
                    <tr>
                        {columns.map(col => (
                            <th key={col} style={{
                                ...
                                <Text.Field.Label style={{ fontSize: "11px", fontWeight: 600, color: "var(--text-tertiary)" }}>
                                    {col.toUpperCase()}
                                </Text.Field.Label>
                            </th>
                        ))}
                ...
                <tbody>
                    {data.map((row, i) => (
                        <tr key={i} style={{
                            borderBottom: i < data.length - 1 ? "1px solid var(--border-neutral-default)" : "none",
                            backgroundColor: i % 2 === 1 ? "var(--surface-bg-sunken)" : "transparent"
                        }}>
                            {columns.map(col => (
                                <td key={col} style={{
                                    padding: "6px 12px", // Relaxed padding
