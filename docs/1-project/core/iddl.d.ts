...
export namespace IDDL {
    ...
    export interface PageProps {
        ...
        title?: string;
        description?: string;
        template?: string; // Layout template (e.g. 'Studio', 'Sidebar')
    }

    // --- Level 1: Section ---

    export type SectionRole =
        | 'Header' | 'Footer' | 'Main' | 'Navigation' | 'Sidebar' | 'Search' | 'Region' | 'Modal' | 'Drawer';
    ...
    export type BlockRole =
        // Layout
        | 'Card' | 'Stack' | 'GridLayout' | 'ScrollArea'
        // Navigation
        | 'AppBar' | 'Toolbar' | 'Breadcrumbs' | 'Tabs' | 'Pagination'
        // Data Display
        | 'List' | 'DataTable' | 'TreeView' | 'EmptyState'
        // Forms
        | 'Form' | 'FieldGroup' | 'Combobox' | 'FilterBar'
        // Overlays
        | 'Menu' | 'Popover' | 'Tooltip' | 'Toast'
        // Utility
        | 'Group' | 'Row' | 'Spacer'
        | string;
    ...
    export type FieldRole =
        | 'TextInput' | 'TextArea' | 'NumberInput' | 'PasswordInput' | 'EmailInput' | 'SearchInput'
        | 'Select' | 'Combobox' | 'Checkbox' | 'Switch' | 'RadioGroup'
        | 'DateInput' | 'TimeInput' | 'DateTimeInput' | 'FileInput'
        | 'Slider' | 'OTPInput' | 'TagInput' | 'Rating';
    ...
    export type FieldSpec =
        ...
        | { role: 'Combobox'; options: FieldOption[]; freeSolo?: boolean; filter?: 'contains' | 'startsWith' | 'none' }
