...
interface ReactFiber {
  ...
  _debugInfo?: { fileName: string; lineNumber: number; columnNumber: number };
...
declare global {
  interface Window {
    __REACT_DEVTOOLS_GLOBAL_HOOK__?: {
      renderers: Map<number, { findFiberByHostInstance: (element: HTMLElement) => ReactFiber }>;
    };
  }
}
...
function showPanel(target: HTMLElement, layers: ComponentLayer[]) {
...
function getMaxZIndex(target: HTMLElement, current: number): number {
...
function getLayersForElement(element: HTMLElement): ComponentLayer[] {
...
function getPath(fiber: ReactFiber): string | undefined {
...
function getReactInstanceForElement(element: HTMLElement): ReactFiber | undefined {
